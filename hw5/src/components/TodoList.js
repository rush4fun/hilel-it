    ...
    return (
        <div className="list-wrapper">
            <div>
                ...
                {todosCol1.length ? 
                    <button onClick={() => handleMoveFromFirstToSecond()}>Transfer first to right</button> 
                : null}
            </div>
            <div>
                <ul>
                ...
                {todosCol2.length ?
                    <div className="list-btn-wrapper">
                        ...
                        <button onClick={() => handleMoveFromSecondToThird()}>Transfer first to right</button> 
                    </div>
                : null}
            </div>
            <div>
